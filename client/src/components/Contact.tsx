...
export default function Contact() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.visitorName || !formData.visitorEmail || !formData.subject || !formData.message) {
    ...
    try {
      ...
      setFormData({ visitorName: '', visitorEmail: '', visitorPhone: '', subject: '', message: '' });
    } catch (error) {
          ...
          <div className="bg-white rounded-lg border border-border p-8 shadow-sm">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label htmlFor="visitorName" className="block text-sm font-semibold text-primary mb-2">
                    Full Name *
                  </label>
                  <input
                    type="text"
                ...
                <div>
                  <label htmlFor="visitorEmail" className="block text-sm font-semibold text-primary mb-2">
                    Email Address *
                  </label>
                  <input
                    type="email"
              ...
              <div>
                <label htmlFor="visitorPhone" className="block text-sm font-semibold text-primary mb-2">
